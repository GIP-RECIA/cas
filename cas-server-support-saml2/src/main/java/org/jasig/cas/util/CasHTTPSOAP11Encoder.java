...
public final class CasHTTPSOAP11Encoder extends HTTPSOAP11Encoder {
	...
	protected Envelope buildSOAPMessage(final SAMLObject samlMessage) {
		final XMLObjectBuilderFactory builderFactory = org.opensaml.xml.Configuration.getBuilderFactory();
		...
		final Envelope envelope = envBuilder.buildObject(
				SOAPConstants.SOAP11_NS, Envelope.DEFAULT_ELEMENT_LOCAL_NAME, CasHTTPSOAP11Encoder.OPENSAML_11_SOAP_NS_PREFIX);
		...
		final Body body = bodyBuilder.buildObject(
				SOAPConstants.SOAP11_NS, Body.DEFAULT_ELEMENT_LOCAL_NAME, CasHTTPSOAP11Encoder.OPENSAML_11_SOAP_NS_PREFIX);
